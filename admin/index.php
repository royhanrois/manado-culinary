...
<html>
  <head>
    ...
    function getCurrentPageFromUrl() {
      return window.location.hash ? window.location.hash.substring(1) : "adminHome";
    }
      ...
      <div class="row h-100">
        <div class="col-md-2 side-panel">
          ...
          <nav class="nav flex-column">
            <a class="nav-link" href="#" data-page="adminHome">Home</a>
            <a class="nav-link" href="#" data-page="adminRestaurant">Restaurant</a>
            <a class="nav-link" href="#" data-page="adminUsers">Users</a>
            <a class="nav-link" href="#" data-page="adminAccount">Account</a>
          </nav>
